...
export interface MathViewCommonProps extends ViewProps {
  ...
  renderError?:
    | React.FC<MathViewErrorProps>
    | React.ReactElement<MathViewErrorProps>;
...
export interface MathViewInjectedProps
  extends MathViewCommonProps,
    ParserResponse {}
...
export const getPreserveAspectRatio = (alignment: string, scale: string) =>
  `${alignment} ${scale}`;
